...
<div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
    <div class="p-6 border-b border-gray-100">
        <h3 class="font-bold text-gray-800"><i class="fas fa-tags text-primary"></i> Atur Harga Kamar</h3>
        ...
        <table class="w-full text-left">
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50 transition">
                    ...
                    <td class="p-4 text-primary font-bold">Rp {{ number_format($kamar->harga, 0, ',', '.') }}</td>
    ...
    <div class="bg-white w-96 rounded-2xl p-6 shadow-2xl">
        ...
        <form id="priceForm" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="number" name="harga" id="modalHarga" class="w-full border rounded-lg p-3 mt-1 focus:ring-primary font-bold text-lg" required>
            </div>
            <div class="flex justify-end gap-2">
                ...
                <button type="submit" class="px-6 py-2 bg-primary text-white font-bold rounded-lg hover:bg-primary-dark">Update</button>
            </div>
        </form>
    </div>
</div>
