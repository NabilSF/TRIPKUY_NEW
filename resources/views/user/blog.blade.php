...
<div class="bg-[#f8f9fa] py-16 border-b border-gray-200">
    <div class="max-w-7xl mx-auto px-4 text-center">
        <span class="text-primary font-bold tracking-widest uppercase text-xs mb-2 block">TripKuy Blog</span>
...
<div class="max-w-7xl mx-auto px-4 py-12">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16 items-center">
        <div class="rounded-2xl overflow-hidden h-[400px] shadow-lg group cursor-pointer relative">
            ...
            <div class="absolute top-4 left-4 bg-white/90 backdrop-blur px-3 py-1 rounded-lg text-xs font-bold text-primary">
                TRENDING
            </div>
        </div>
        <div class="md:pl-6">
            <div class="flex items-center gap-3 text-sm text-gray-500 mb-3">
                <span class="text-primary font-bold uppercase tracking-wider">{{ $articles[0]['category'] }}</span>
                <span>•</span>
                <span>{{ $articles[0]['date'] }}</span>
            </div>
            <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-4 hover:text-primary transition cursor-pointer">
                {{ $articles[0]['title'] }}
            </h2>
   ...
   <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-xl hover:-translate-y-1 transition duration-300 group flex flex-col h-full">
            ...
            <div class="p-6 flex flex-col grow">
                ...
                <h3 class="font-bold text-xl text-gray-800 mb-3 line-clamp-2 group-hover:text-primary transition">
                    {{ $article['title'] }}
                </h3>
                <p class="text-sm text-gray-500 line-clamp-3 mb-4 grow">
                    {{ $article['excerpt'] }}
                </p>
                <a href="#" class="text-primary font-bold text-sm flex items-center gap-1 hover:gap-2 transition-all mt-auto">
    ...
    <div class="mt-20 bg-primary rounded-3xl p-8 md:p-16 text-center relative overflow-hidden">
